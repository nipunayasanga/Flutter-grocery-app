...
class Kiwi extends StatefulWidget {
  Kiwi({Key key, this.title}) : super(key: key);
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("Kiwi-Medium", style: TextStyle(
                          color: Colors.black,
                      ...
                      Padding(
                        ...
                        child: Text('''Kiwi  trees are partially self-pollinating and are
