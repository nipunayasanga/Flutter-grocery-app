              ...
              child: Container(
                child: Row(
                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
                        _buildFruitCard("Carrot", "assets/carrot.png","Rs.100", 0xffF7DFB9, 0XffFAF0DA),
                        ...
                        GestureDetector(
                          ...
                          child: _buildFruitCard("Lady Finger", "assets/ladyFinger.png","Rs.120", 0xffC4D4A3, 0XffE0E8CF),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildFruitCard("Tomatoes", "assets/tomatoes.png","Rs.150", 0xffF6E475, 0XffF9EFB0),
                      ],
                    ),
                    Spacer(),
                    Column(
                      children: <Widget>[
                        ...
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildFruitCard("Cabbage", "assets/cabbage.png","Rs.45", 0xffFFC498, 0XffFDDCC1),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildFruitCard("Broccoli", "assets/Broccoli.png","Rs.200", 0xffF0AEAF, 0XffF8C6CA),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                      ],
                    )
                  ],
