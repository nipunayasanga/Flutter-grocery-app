              ...
              child: Container(
                child: Row(
                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
                        _buildFruitCard("Sunflower Seeds", "assets/sunflowerseeds.png","Rs.100", 0xffF7DFB9, 0XffFAF0DA),
                        ...
                        GestureDetector(
                          ...
                          child: _buildFruitCard("Cashew", "assets/cashew.png","Rs.120", 0xffC4D4A3, 0XffE0E8CF),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildFruitCard("Coffeenuts", "assets/coffeenuts.png","Rs.250", 0xffF6E475, 0XffF9EFB0),
                      ],
                    ),
                    Spacer(),
                    Column(
                      children: <Widget>[
                        ...
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildFruitCard("Nuts&seeds", "assets/Nutsandseeds.png","Rs.450", 0xffFFC498, 0XffFDDCC1),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            padding: const EdgeInsets.only(left: 10.0, top: 10.0),
            child: Text("Lorem ipusam", style: TextStyle(
                fontFamily: 'OpenSans-Bold',
                fontWeight: FontWeight.bold,
                fontSize: 1.5 * SizeConfig.textMultiplier
            ),),
