              ...
              child: Container(
                child: Row(
                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
                        _buildFruitCard("Milk", "assets/milk.png","Rs.90", 0xffF7DFB9, 0XffFAF0DA),
                        ...
                        GestureDetector(
                          ...
                          child: _buildFruitCard("Butter", "assets/butter.png","Rs.120", 0xffC4D4A3, 0XffE0E8CF),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildFruitCard("Chees", "","Rs.150", 0xffF6E475, 0XffF9EFB0),
                      ],
                    ),
                    Spacer(),
                    Column(
                      children: <Widget>[
                        ...
                        // SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        // _buildFruitCard("Papaya", "assets/papaya.png","Rs.45", 0xffFFC498, 0XffFDDCC1),
                        // SizedBox(height: 2 * SizeConfig.heightMultiplier,),
